...
import { StatusCode, SearchQuery, sendResponse, AuthenticatedRequest, IdParam, NoParams, ApiResponse, PaginatedData } from '../shared';
...
export class UserController {
  ...
  async getMe(req: AuthenticatedRequest, res: Response): Promise<Response<ApiResponse<UserPublicInfo>>> {
  ...
  async deleteUserById(req: AuthenticatedRequest<unknown, IdParam>, res: Response): Promise<Response<ApiResponse<void>>> {
  ...
  async findUsers(
    ...
    res: Response,
  ): Promise<Response<ApiResponse<PaginatedData<UserPublicInfo>>>> {
